...
Aaj ke liye itna hi. Practice karo, code likho, aur mazza karo!""",
    ...
    'challenges': [
      ...
      {
        'question': 'Ek string lo "PythonProgramming" aur uske har even index ka character print karo (0, 2, 4...). Step size ka use karo slicing mein.',
        'hint': 'String slicing mein third parameter step size hota hai. Jaise name[0:len(name):2]',
        'solution': 'text = "PythonProgramming"\nprint(text[0:len(text):2])',
        'difficulty': 'medium',
      },
      {
        'question': 'Ek string lo aur usko reverse karo bina kisi built-in function ke -- sirf slicing se. Jaise "Harry" ko "yrraH" karna hai.',
        'hint': 'Slicing mein step size -1 do. Jaise name[::-1]. Start aur end blank rakhoge to poori string lega.',
        'solution': 'name = "Harry"\nprint(name[::-1])',
        'difficulty': 'hard',
      },
    ],
...
ChatGPT se aur functions poochh lo -- jaise lower(), upper(), title(), strip(). Bohot saare functions hain, sab yaad karne ki zaroorat nahi. Jab chahiye tab ChatGPT se puch lo!''',
    ...
    'challenges': [
      ...
      {
        'question': 'Ek function banao jo ek string input le aur usme har word ka first character capital kare WITHOUT using title() method. Sirf capitalize() ya loops ka use karo.',
        'hint': 'String ko split() se words mein todo, har word pe capitalize() lagao, phir join() se wapas jodo.',
        'solution': 'def custom_title(s):\n    words = s.split()\n    capitalized = [w.capitalize() for w in words]\n    return " ".join(capitalized)\n\nprint(custom_title("hello world python"))',
        'difficulty': 'hard',
      },
    ],
    'importantSyntax': [
