...
Bahut easy hai! Chalo ab data types dekhte hain.''',
    ...
    'challenges': [
      ...
      {
        'question': 'Do variables banao jisme ek number aur ek string ho. Phir unhe add karne ki koshish karo aur dekho kya error aata hai. Phir string ko number mein convert karke add karo.',
        'hint': 'a = 5, b = "10". a + b se TypeError aayega. a + int(b) se kaam hoga.',
        'solution': 'a = 5\nb = "10"\n# print(a + b)  # TypeError\na = 5\nb = int("10")\nprint(a + b)  # 15',
        'difficulty': 'medium',
      },
      {
        'question': 'Ek program likho jisme 5 variables alag-alag data types ke ho (int, float, str, bool, None). Har variable ko ek line mein print karo aur saath mein uska type bhi batayo.',
        'hint': 'type() function variable ka type batata hai. Print karte waqt print(variable, type(variable)) use karo.',
        'solution': 'a = 42\nb = 3.14\nc = "Hello"\nd = True\ne = None\nprint(a, type(a))\nprint(b, type(b))\nprint(c, type(c))\nprint(d, type(d))\nprint(e, type(e))',
        'difficulty': 'hard',
      },
    ],
...
Simple hai na? Chalo ab dekhte hain identifiers aur rules ke baare mein!''',
    ...
    'challenges': [
      {
        'question': 'Har data type (int, float, str, bool, None) ka ek variable banao aur type() se check karo.',
        'hint': '5 variables banao: a = 10 (int), b = 2.5 (float), c = "Py" (str), d = True (bool), e = None. Phir har ek ko type() se print karo.',
        'solution': 'a = 10\nb = 2.5\nc = "Python"\nd = True\ne = None\nprint(type(a))\nprint(type(b))\nprint(type(c))\nprint(type(d))\nprint(type(e))',
        'difficulty': 'easy',
      },
      {
      ...
      {
        'question': 'Ek program likho jisme aap kisi variable ka type multiple times change karo (int → float → string → bool). Har change ke baad variable ki value aur type print karo.',
...
Toh yaad rakho: Letters, digits, underscore — bas yahi teen cheezein allowed hain. Aur digit se start nahi karna. Simple rules hain — follow karo aur error se bacho!''',
    ...
    'challenges': [
      ...
      {
        'question': 'Ek program likho jo user se ek identifier input le aur check kare ki woh valid hai ya nahi (rules ke according). Multiple test cases handle karo.',
        'hint': 'Input lo, phir manually check karo: .isidentifier() method bhi hai Python mein. Ya phir manually rules check karo — start letter/underscore se, no special chars except underscore.',
        'solution': 'identifier = input("Enter identifier: ")\nif identifier.isidentifier():\n    print(f"\'{identifier}\' is a valid identifier")\nelse:\n    print(f"\'{identifier}\' is NOT a valid identifier")',
        'difficulty': 'hard',
      },
    ],
    'importantSyntax': [
...
Bahut saare types hain operators ke, but itna basics enough hai abhi ke liye. Aage chalke aur dekhenge!''',
    ...
    'challenges': [
      ...
      {
        'question': 'Ek program likho jo kisi number ko 2 se check kare ki woh even hai ya odd — using modulus operator aur logical operators.',
        'hint': 'a % 2 == 0 → even. Logical operators use karo multiple numbers check karne ke liye ya conditions combine karne ke liye.',
        'solution': 'num = int(input("Enter a number: "))\nis_even = (num % 2 == 0)\nis_odd = not is_even\nprint("Is even?", is_even)\nprint("Is odd?", is_odd)',
        'difficulty': 'medium',
      },
      {
        'question': 'Ek program likho jo teen numbers input le aur unmein se sabse bada number find kare using comparison aur logical operators. without using max() function.',
        'hint': 'a > b and a > c → a sabse bada. b > a and b > c → b sabse bada. else → c sabse bada. Logical AND use karo conditions combine karne ke liye.',
...
Yaad rakho: type() → pucho, int/float/str → badlo, aur careful raho ki galat conversion na karne do!''',
    ...
    'challenges': [
      ...
      {
        'question': 'Ek program likho jo user se ek number string ki form mein le (jaise "123.45"), use float mein convert kare, phir integer mein, phir result print kare. Note karo ki decimal part kya hota hai.',
        'hint': 'float("123.45") → 123.45. Phir int(123.45) → 123 (decimal part 0.45 loss). Ye data loss ka example hai.',
        'solution': 'user_input = input("Enter a number: ")\nfloat_val = float(user_input)\nint_val = int(float_val)\nprint("Float:", float_val)\nprint("Integer:", int_val)\nprint("Data loss:", float_val - int_val)',
        'difficulty': 'medium',
      },
      {
        'question': 'Ek program likho jo error handling ke saath user se number input le. Agar user kuch aisa type kare jo number mein convert nahi ho sakta (jaise "hello"), toh error ko catch karke user ko friendly message dikhao.',
        'hint': 'try-except use karo. try: int(input()) except ValueError: print("Sahi number daal bhai!")',
        'solution': 'try:\n    num = int(input("Enter a number: "))\n    print("Number:", num)\nexcept ValueError:\n    print("Error! Yeh number nahi hai. Kripya sahi number daalein.")',
        'difficulty': 'hard',
      },
    ],
    'importantSyntax': [
