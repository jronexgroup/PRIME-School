...
Yaad rakho: Dictionary = key-value pairs ka collection. Ordered, changeable, aur unique keys.''',
    ...
    'challenges': [
      ...
      {
        'question': 'Ek program likho jo do dictionaries ko merge kare. Jaise ek dictionary mein Hindi words hain aur dusre mein English. Dono ko ek saath print karo.',
        'hint': 'Aap ek nayi dictionary bana sakte ho aur saare pairs manually daal sakte ho. Ya phir update() method use kar sakte ho (jo hum agle topic mein seekhenge).',
        'solution': "hindi_eng = {\"apple\": \"seb\", \"banana\": \"kela\"}\neven_more = {\"mango\": \"aam\", \"grapes\": \"angoor\"}\n\n# Manual merge — ek nayi dictionary mein daalo\nall_words = {}\nfor key, value in hindi_eng.items():\n    all_words[key] = value\nfor key, value in even_more.items():\n    all_words[key] = value\n\nprint(all_words)",
        'difficulty': 'medium',
      },
      {
        'question': 'Ek program likho jo ek dictionary se keys aur values swap kare. Jaise {"a": 1, "b": 2} ko {1: "a", 2: "b"} mein convert karo.',
        'hint': 'For loop mein dict.items() se key-value pair lo aur nayi dictionary mein value:key assign karo.',
