...
Chalo ab examples dekhte hain!''',
    ...
    'challenges': [
      ...
      {
        'question': 'Ek paragraph lo jisme multiple spaces hain aur punctuations hain (like ! , . ? ; :). Ek program likho jo: (1) punctuations hata de using replace() (2) extra spaces hata de (3) saare words ko lowercase kare (4) unique words ki alphabetically sorted list return kare using sorted().',
        'hint': 'Punctuations manually list karo: ".!?,;:". for loop se replace karo. text.lower().split() karo, set() use karo unique ke liye, sorted() use karo.',
        'solution': "text = \"Hello!!! This is  a  sample... Text with  extra spaces & punctuation!\"\n\npunctuations = \".!?,;:&\"\nfor p in punctuations:\n    text = text.replace(p, \" \")\n\nwords = sorted(set(text.lower().split()))\nprint(\"Cleaned unique words:\")\nprint(words)",
        'difficulty': 'hard',
      },
    ],
    'importantSyntax': [
